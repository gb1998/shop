...
<%
ResultSet rs=conn.executeQuery("select * from tb_goods order by INTime ");
%>
<html>
<head>
...
for(int i=1;i<=pagesize;i++){
	  ...
	  %>
              ...
              <tr style="padding:5px;">
                ...
                <td align="center"><a href="${pageContext.request.contextPath}/upDateServlet?ID=<%=ID%>"><img src="images/modify.gif" width="19" height="19"></a></td>
